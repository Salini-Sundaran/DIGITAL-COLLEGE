...
<head>
    ...
    <title>Greensward - Gardening Category Bootstrap Responsive Website Template - About Us : W3Layouts</title>
    <!-- google-fonts -->
        ...
        <img src="image-path" alt="Your logo" title="Your logo" style="height:35px;" />
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                    <ul class="navbar-nav ml-lg-auto">
						...
						<li class="dropdown">
						<li><a href="" class="dropdown-toggle hvr-bounce-to-bottom" data-toggle="dropdown" role="button">Faculty<span class="caret"></span></a>
									<ul class="dropdown-menu">
										<li><a class="hvr-bounce-to-bottom" href="facultyreg">Add Faculty</a></li>
...
<!-- footer -->
    <footer class="w3l-footer-16">
                    ...
                    <div class="col-lg-3 col-md-5 col-sm-6 column">
                        ...
                        <ul class="column2">
                            <li class="d-flex align-items-center"><a href="mailto:info@example.com"><i
                                        class="fas fa-envelope-open-text"></i>info@example.com</a>
                            </li>
                            <li class="py-sm-3 py-2 d-flex align-items-center"><a href="tel:+44-000-888-999"><i
                                        class="fas fa-phone-alt"></i>+44-000-888-999</a>
                            </li>
                            <li class="d-flex align-items-center">
                                <p class="contact-para"><i class="fas fa-map-marker-alt"></i>London,
                                    235 Terry, 10001</p>
                            </li>
                        </ul>
                    </div>
        ...
        <div class="copy-section text-center py-4">
            <div class="container">
                <p class="copy-text">&copy; 2021 Greensward. All rights reserved. Design by <a
